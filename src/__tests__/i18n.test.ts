...
describe("bilingual string maps", () => {
  const maps = [
    ...
    { name: "LIVING_WELL_REPORT.title", obj: LIVING_WELL_REPORT.title },
    { name: "MENTAL_HEALTH_REPORT.title", obj: MENTAL_HEALTH_REPORT.title },
    { name: "EDUCATION_REPORT.title", obj: EDUCATION_REPORT.title },
    { name: "ENGINEERING_REPORT.title", obj: ENGINEERING_REPORT.title },
    { name: "AGRICULTURE_REPORT.title", obj: AGRICULTURE_REPORT.title },
    { name: "ENVIRONMENTAL_REPORT.title", obj: ENVIRONMENTAL_REPORT.title },
    { name: "ARCHAEOLOGY_REPORT.title", obj: ARCHAEOLOGY_REPORT.title },
    { name: "SOCIAL_REPORT.title", obj: SOCIAL_REPORT.title },
    { name: "OFFBEAT_REPORT.title", obj: OFFBEAT_REPORT.title },
